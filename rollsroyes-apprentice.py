...
urls = ["https://rollsroyce.wd3.myworkdayjobs.com/wday/cxs/rollsroyce/Apprentice/jobs",
        "https://rollsroyce.wd3.myworkdayjobs.com/wday/cxs/rollsroyce/Intern_Graduate/jobs",
        ]
jobs_list = []
for url in urls:
    ...
    for sub_links in get_links:
        ...
        data = response.json()
        print(data)
        job_dict = {'jobID': data['jobPostingInfo']['id'],
...
print(jobs_json)
with open('rolls-royce.json', 'w') as json_file:
